  ...
  return (
    <div className='flex flex-col sm:flex-row justify-between gap-4 items-start sm:items-center bg-white p-4 rounded-xl border border-zinc-200 shadow-sm'>
      ...
      <div className='flex gap-3 w-full sm:w-auto flex-wrap sm:flex-nowrap'>
        <button className='flex items-center gap-2 px-3 py-2 bg-white border border-zinc-200 text-zinc-600 rounded-lg text-sm font-medium hover:bg-zinc-50 transition-colors whitespace-nowrap'>
        ...
        <button
          ...
          className='flex items-center justify-center gap-2 px-4 py-2 bg-zinc-900 text-white rounded-lg text-sm font-medium hover:bg-zinc-800 shadow-lg shadow-zinc-200 transition-all whitespace-nowrap'
        >
          <Plus size={18} />
